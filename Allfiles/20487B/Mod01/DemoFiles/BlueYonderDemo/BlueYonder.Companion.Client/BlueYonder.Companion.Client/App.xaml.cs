...
namespace BlueYonder.Companion.Client
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnWindowCreated(WindowCreatedEventArgs args)
        {
            ...
            if (sensor != null)
            {
                sensor.OrientationChanged += SimpleOrientationSensor_OrientationChanged;
            }
        }
        ...
        private void SimpleOrientationSensor_OrientationChanged(SimpleOrientationSensor sender, SimpleOrientationSensorOrientationChangedEventArgs args)
        {
            ...
            if (this.rootFrame != null && this.rootFrame.Content != null)
            {
                Control control = this.rootFrame.Content as Control;
                if (control != null)
                {
